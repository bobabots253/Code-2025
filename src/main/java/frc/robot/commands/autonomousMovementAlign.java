...
public class autonomousMovementAlign extends Command{
    ...
    public autonomousMovementAlign(DriveSubsystem driveSubsystem, Pose2d targetPose){
        ...
        holonomicDriveController.setTolerance(new Pose2d(new Translation2d(0.591, 0.591),
    ...
    public SwerveModuleState[] positionPIDCommand(DriveSubsystem driveSubsystem, Pose2d goalPose){
        ChassisSpeeds chassis = holonomicDriveController.calculate(driveSubsystem.getPose(), targetPose, .75, targetPose.getRotation());
