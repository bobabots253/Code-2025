...
public class DriveSubsystem extends SubsystemBase {
  ...
  final Field2d m_fieldVision_L = new Field2d();
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      SwerveDrivePoseEstimator mono_odometryVision_L = new SwerveDrivePoseEstimator(DriveConstants.kDriveKinematics,
      ...
      SwerveDrivePoseEstimator mono_odometryVision_R = new SwerveDrivePoseEstimator(DriveConstants.kDriveKinematics,
      (fieldFlipped ? getInitialFlippeRotation2d(): getRotation2DHeading()), new SwerveModulePosition[] {
              m_frontLeft.getPosition(),
              m_frontRight.getPosition(),
              m_rearLeft.getPosition(),
      ...
      (fieldFlipped ? getTrueInitialFlippeRotation2d(): getTrueRotation2DHeading()), new SwerveModulePosition[] {
              m_frontLeft.getPosition(),
              m_frontRight.getPosition(),
              m_rearLeft.getPosition(),
              m_rearRight.getPosition()
    ...
    private static class DriveSubsystemHandler {
      ...
      public static DriveSubsystem getInstance() {
        return DriveSubsystemHandler.instance;
    }
  ...
  public Pose2d mono_getPoseVision_R() {
  ...
  public Rotation2d getRotation2DHeading(){
    return Rotation2d.fromDegrees(-Nav_x.getAngle()); //getAngle
  }
